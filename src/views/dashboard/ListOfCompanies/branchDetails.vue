          ...
          <div class="branch_card position-fixed">
            <div class="">
              <div class="row align-items-center mt-3">
                ...
                <div class="col-md-6">
                  <div class="">
                    <h4 class="font-weight">Mushin</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="align-items-center mt-3">
                <p>
                  Phone Number:<span class="font-weight-bold ml-4"
                    >0810203045869</span
                  >
                </p>
                <p>
                  Branch Email:<span class="font-weight-bold text-left ml-5"
                    >fazzy@gmail.com</span
                  >
                </p>
                <p>
                  Branch Address:<span class="font-weight-bold ml-4"
                    >e@gmail.com</span
                  >
                </p>
              </div>
