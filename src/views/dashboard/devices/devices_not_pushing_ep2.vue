                ...
                <div class="col-lg-8 remove-padding-left padding_div pr-0">
                    <div class="dashboard__card small_card align-center">
                        ...
                        <div class="col-md-8 card_inner_wrapper">
                            <h3>Hi, {{userName}}</h3>
                            <p>Get started with epump company admin platform by managing devices not pushing Ep2</p>
                        </div>
                 ...
                 <div class="col-lg-4">
                    <div class="dashboard__card large_card">
                        <div class="small__card_content_wrapper align-items-center justify-content-center" >
                            <p class="dashboard__card__header text-white">Total number of Devices Not Pushing   Ep2</p>
            ...
            .get(
                ...
                .then(res => {
                    ...
                    res.data.forEach(el => {
                        ...
                        el.lastEp2Date = this.timeSince(new Date(el.lastEp2Date))
                    })
