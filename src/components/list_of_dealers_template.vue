<template>
  ...
  <div class="">
    <router-link :to="{name:'editDealers', query: {companyId: data.id}}" class="btn details_btn mr-3">
      Edit
    </router-link>

    <router-link :to="{name:'dealerDetails',  query: {companyId: data.id}}" class="btn dealers_btn mr-3">
      Dealers
    </router-link>

    <router-link :to="{name:'dealer_branches', query: {companyId: data.id}}" class="btn branches_btn mr-3">
      Branches
    </router-link>
